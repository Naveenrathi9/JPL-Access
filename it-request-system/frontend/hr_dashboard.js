...
function displayRequests(requests, filter = "all") {
  ...
  filteredRequests.forEach((request) => {
    ...
    tr.innerHTML = `
            ...
            <td>
                ${
                  request.status.hr === "pending"
                    ? `
                    <button class="btn btn-sm btn-outline-success action-btn approve" data-id="${request._id}" data-role="hr">
                        <i class="fas fa-check"></i>
                    </button>
                    <button class="btn btn-sm btn-outline-danger action-btn reject" data-id="${request._id}" data-role="hr">
